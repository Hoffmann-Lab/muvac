...
say "#chr\tpos\tref\talt\tdbsnp\tgene\tgeneid\tintron/exon\t#samples\tsamples\t#maxCallerOneSample\t#callerAllSamples\tcallerAllSamples\tmaxCOV\tmaxMAF\t
	COV,MAF,caller-sample1...\tCOV-sample1...\tMAF-sample1...\tcaller-sample1...";
